...
<?php foreach ($formError as $error) { ?>
    ...
    <form action="#" method="POST" enctype="multipart/form-data">
        ...
        <label for="birthdate" class="<?= isset($formError['birthdate']) ? 'inputError' : '' ?>"> Date de naissance* : </label><input type="date" name="birthdate" value="<?= $user->birthdate ?>" min="1900-01-01" max="<?= date('Y-m-d'); ?>" />
